...
def profile_upload(request):
        ...
        # data_set = csv_file.read().decode('UTF-8')
            ...
            engine = create_engine('postgresql://postgres:123456@localhost:5432/iplmatches')
            data_set.to_sql('vivoiplpapp_ipltask', engine,if_exists='replace')
...
def population_chart(request):
    ...
    queryset = Ipltask.objects.values()[:5]
...
def maximum_player_match(request):
    ...
    queryset = Ipltask.objects.values("player_of_match")
...
def toss_winner(request):
    ...
    queryset = Ipltask.objects.values("toss_winner")
...
def winner(request):
    ...
    queryset = Ipltask.objects.values("winner")
